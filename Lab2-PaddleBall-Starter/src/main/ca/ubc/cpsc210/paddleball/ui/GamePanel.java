...
public class GamePanel extends JPanel {
    ...
    GamePanel(PaddleBallGame g) {
        setPreferredSize(new Dimension(PaddleBallGame.WIDTH, PaddleBallGame.HEIGHT));
    ...
    private void drawBall(Graphics g) {
        ...
        g.fillOval(b.getPosX() - Ball.SIZE / 2, b.getPosY() - Ball.SIZE / 2, Ball.SIZE, Ball.SIZE);
        g.setColor(savedCol);
    }
    ...
    private void drawGameOver(Graphics g) {
        ...
        centreString(OVER, g, fm, PaddleBallGame.HEIGHT / 2);
        centreString(REPLAY, g, fm, PaddleBallGame.HEIGHT / 2 + 50);
        g.setColor(saved);
    }
    ...
    private void centreString(String str, Graphics g, FontMetrics fm, int y) {
        ...
        g.drawString(str, (PaddleBallGame.WIDTH - width) / 2, y);
    }
}
